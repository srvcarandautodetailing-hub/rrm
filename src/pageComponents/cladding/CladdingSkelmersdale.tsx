...
export function CladdingSkelmersdale() {
  useEffect(() => {
    const schema = {
      '@context': 'https://schema.org',
      '@type': 'LocalBusiness',
      name: 'Cladding Cleaning Skelmersdale | Professional Soft Washing Service',
      description: 'Expert cladding cleaning for Skelmersdale properties. Safe algae, mold, and pollution removal from all cladding types.',
    ...
    document.title = 'Cladding Cleaning Skelmersdale | Professional Soft Washing';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional cladding cleaning in Skelmersdale. Safe soft washing for all cladding types. Call 07845 463877');
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Professional Cladding Cleaning in Skelmersdale
          </h1>
          <p className="text-lg text-muted-foreground mb-6">
            Expert soft washing for Skelmersdale properties. Safe removal of algae, mold, and environmental stains.
          </p>
        ...
        <div className="max-w-4xl">
          <section className="mb-12">
            <p className="text-muted-foreground leading-relaxed mb-8">
              Skelmersdale properties require professional cladding maintenance to manage North West moisture and environmental soiling. Our soft washing safely removes algae, mold, and pollution stains from UPVC, metal, and aluminium cladding.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Professional removal of algae, mold, and contaminants.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
              ...
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Maintains Asset Value</h3>
                  <p className="text-muted-foreground text-sm">Clean appearance preserves property investment and appeal.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Extends Cladding Life</h3>
                  <p className="text-muted-foreground text-sm">Preventive maintenance delays expensive replacement.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                ...
                <p className="text-muted-foreground mt-4">We use biodegradable solutions safe for gardens and the environment.</p>
              </details>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Cladding Cleaning in Skelmersdale</h2>
