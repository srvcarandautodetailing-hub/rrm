...
export function CladdingWigan() {
  useEffect(() => {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      name: 'Cladding Cleaning Wigan | Professional Soft Washing Service',
      description: 'Expert cladding cleaning for Wigan properties. Safe algae, mold, and pollution removal from all cladding types.',
    ...
    document.title = 'Cladding Cleaning Wigan | Professional Soft Washing';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional cladding cleaning in Wigan. Safe soft washing for all cladding types. Call 07845 463877');
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Professional Cladding Cleaning in Wigan
          </h1>
          <p className="text-lg text-muted-foreground mb-6">
            Expert soft washing for Wigan properties. Safe removal of algae, mold, and environmental stains.
          </p>
        ...
        <div className="max-w-4xl">
          <section className="mb-12">
            <p className="text-muted-foreground leading-relaxed mb-8">
              Wigan properties require professional cladding maintenance due to North West moisture and environmental soiling. Our soft washing safely removes algae, mold, and pollution stains from all cladding types.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Removes Algae & Mold</h3>
                  <p className="text-muted-foreground text-sm">Professional removal of biological growth and contaminants.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Soft washing protects UPVC, metal, and aluminium.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Prevents Deterioration</h3>
                  <p className="text-muted-foreground text-sm">Regular maintenance extends cladding lifespan.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Enhances Property Value</h3>
                  <p className="text-muted-foreground text-sm">Clean appearance maintains curb appeal and investment.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                ...
                <p className="text-muted-foreground mt-4">Yes. Professional soft washing is safe for all cladding types.</p>
              </details>
              ...
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                ...
                <p className="text-muted-foreground mt-4">Every 2-3 years typically. Professional assessment determines your specific needs.</p>
              </details>

              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  Are your solutions environmentally safe?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">Yes. We use biodegradable solutions safe for gardens and the environment.</p>
              </details>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/services/render-cleaning" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
                ...
                <p className="text-sm text-muted-foreground">Facade cleaning</p>
              </Link>
          ...
          <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Cladding Cleaning in Wigan</h2>
