...
export function CladdingGolborne() {
  useEffect(() => {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      name: 'Cladding Cleaning Golborne | Professional Soft Washing Service',
      description: 'Expert cladding cleaning for Golborne properties. Safe algae, mold, and pollution removal from all cladding types.',
    ...
    document.title = 'Cladding Cleaning Golborne | Professional Soft Washing';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional cladding cleaning in Golborne. Safe soft washing for all cladding types. Call 07845 463877');
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Professional Cladding Cleaning in Golborne
          </h1>
          <p className="text-lg text-muted-foreground mb-6">
            Expert soft washing for Golborne properties. Safe removal of algae, mold, and environmental stains.
          </p>
        ...
        <div className="max-w-4xl">
          <section className="mb-12">
            <p className="text-muted-foreground leading-relaxed mb-8">
              Golborne properties require professional cladding maintenance due to North West moisture and pollution. Our soft washing safely removes algae, mold, and environmental stains from UPVC, metal, and aluminium cladding.
            </p>

            <h2 className="text-2xl font-bold text-foreground mb-6">Professional Cladding Cleaning</h2>
            <div className="space-y-4">
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Removes Growth Safely</h3>
                  <p className="text-muted-foreground text-sm">Professional removal of algae, mold, and biological growth.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Protects Material</h3>
                  <p className="text-muted-foreground text-sm">Soft washing prevents damage that pressure washing causes.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Extends Lifespan</h3>
                  <p className="text-muted-foreground text-sm">Regular maintenance prevents premature deterioration.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Improves Appearance</h3>
                  <p className="text-muted-foreground text-sm">Clean cladding enhances property value and curb appeal.</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Identify cladding type and soiling issues.</p>
                </div>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Complete low-pressure rinsing.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Final check and recommendations.</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  Is soft washing safe for all cladding?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">Yes. Professional soft washing is safe for UPVC, metal, and aluminium cladding.</p>
              </details>
              ...
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                ...
                <p className="text-muted-foreground mt-4">Every 2-3 years typically. We recommend a schedule based on your property's specific needs.</p>
              </details>

              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  Are the cleaning solutions eco-friendly?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">Yes. We use biodegradable solutions that are safe for gardens and the environment.</p>
              </details>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/services/render-cleaning" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
                ...
                <p className="text-sm text-muted-foreground">Facade cleaning and restoration</p>
              </Link>
          ...
          <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Cladding Cleaning in Golborne</h2>
