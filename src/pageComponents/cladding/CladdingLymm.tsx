...
export function CladdingLymm() {
  useEffect(() => {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      name: 'Cladding Cleaning Lymm | Professional Soft Washing Service',
      description: 'Expert cladding cleaning for Lymm properties. Safe algae, mold, and pollution removal from UPVC, metal, and aluminium cladding.',
    ...
    document.title = 'Cladding Cleaning Lymm | Professional Soft Washing';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional cladding cleaning in Lymm. Safe soft washing removes algae and mold. Call 07845 463877');
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Professional Cladding Cleaning in Lymm
          </h1>
          <p className="text-lg text-muted-foreground mb-6">
            Expert soft washing for Lymm properties. Safe removal of algae, mold, and environmental stains from all cladding types.
          </p>
        ...
        <div className="max-w-4xl">
          <section className="mb-12">
            <p className="text-muted-foreground leading-relaxed mb-8">
              Lymm's rural setting with North West dampness means cladding requires regular professional maintenance. Algae, mold, and environmental stains accumulate on UPVC, metal, and aluminium cladding. Professional soft washing restores appearance while protecting your building materials.
            </p>

            <h2 className="text-2xl font-bold text-foreground mb-6">Professional Cladding Maintenance</h2>
            <div className="space-y-4">
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Removes Biological Growth</h3>
                  <p className="text-muted-foreground text-sm">Algae and mold are safely eliminated without damaging your cladding.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Improves Property Appearance</h3>
                  <p className="text-muted-foreground text-sm">Clean cladding dramatically enhances curb appeal and property value.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Extends Material Life</h3>
                  <p className="text-muted-foreground text-sm">Regular maintenance prevents premature deterioration and replacement costs.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
            ...
            <div className="space-y-4">
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  How often should Lymm cladding be cleaned?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">Every 2-3 years is typical for North West properties. We'll recommend the best schedule for your property.</p>
              </details>
              ...
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                ...
                <p className="text-muted-foreground mt-4">No. Professional soft washing is safe and effective. Pressure washing causes permanent damage.</p>
              </details>

              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  What cladding types do you clean?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">We clean UPVC, metal, aluminium, and composite cladding with specialized techniques.</p>
              </details>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Cladding Cleaning in Lymm</h2>
