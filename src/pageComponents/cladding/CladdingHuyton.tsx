...
export function CladdingHuyton() {
  useEffect(() => {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      name: 'Cladding Cleaning Huyton | Professional Soft Washing Service',
      description: 'Expert cladding cleaning for Huyton properties. Safe algae, mold, and pollution removal from all cladding types.',
    ...
    document.title = 'Cladding Cleaning Huyton | Professional Soft Washing';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional cladding cleaning in Huyton. Safe soft washing for all cladding types. Call 07845 463877');
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Professional Cladding Cleaning in Huyton
          </h1>
          <p className="text-lg text-muted-foreground mb-6">
            Expert soft washing for Huyton properties. Safe removal of algae, mold, and environmental stains.
          </p>
        ...
        <div className="max-w-4xl">
          <section className="mb-12">
            <p className="text-muted-foreground leading-relaxed mb-8">
              Huyton properties benefit from professional cladding maintenance to combat North West moisture and environmental soiling. Our soft washing safely removes algae, mold, and pollution stains from all cladding types.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Eliminates Biological Growth</h3>
                  <p className="text-muted-foreground text-sm">Safe removal of algae, mold, and biological contaminants.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Protects Cladding Materials</h3>
                  <p className="text-muted-foreground text-sm">Soft washing prevents damage from high-pressure alternatives.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Clean appearance protects investment and appeal.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Preventive maintenance avoids expensive replacement.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                ...
                <p className="text-muted-foreground mt-4">Yes. Soft washing is safe for UPVC, metal, aluminium, and composite cladding.</p>
              </details>

              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  How often should cladding be professionally cleaned?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">Every 2-3 years is typical. Professional assessment determines your property's specific needs.</p>
              </details>

              <details className="bg-secondary/30 rounded-lg p-6 cursor-pointer group">
                <summary className="font-semibold text-foreground flex justify-between items-center">
                  Will soft washing leave residue or damage plants?
                  <span className="text-accent group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="text-muted-foreground mt-4">No. We use biodegradable solutions and protect landscaping during cleaning.</p>
              </details>
            </div>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">Our Other Services</h2>
          ...
          <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Cladding Cleaning in Huyton</h2>
