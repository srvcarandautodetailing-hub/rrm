...
export function ExteriorCleaningSkelmersdale() {
  ...
  const breadcrumbs = [
    ...
    { name: 'Skelmersdale', url: '/services/exterior-cleaning/skelmersdale' }
  ];
      ...
      <main className="min-h-screen bg-background">
        ...
        <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
          <div className="container-custom section-padding">
            ...
            <p className="text-xl text-muted-foreground mb-6">Professional exterior cleaning for Skelmersdale properties. Pressure washing, soft washing, driveway, roof, and gutter cleaning services.</p>
        ...
        <div className="container-custom section-padding">
          <div className="max-w-4xl">
            <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
              <p className="font-bold text-foreground mb-4">Professional exterior cleaning serving Skelmersdale and surrounding areas</p>
