...
export function GutterGolborne() {
  useEffect(() => {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      name: 'Gutter Cleaning in Golborne | R.R.M Exterior Cleaning',
      description: 'Professional gutter cleaning and maintenance in Golborne.',
    ...
    document.title = 'Gutter Cleaning Golborne | Professional Gutter Services';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional gutter cleaning in Golborne. Call: 07845 463877');
  ...
  const breadcrumbs = [
    ...
    { name: 'Golborne', url: '/services/gutter-cleaning/golborne' }
  ];
    ...
    <Layout>
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">Professional Gutter Cleaning in Golborne</h1>
          <p className="text-xl text-muted-foreground mb-6">Expert gutter cleaning services for Golborne properties.</p>
      ...
      <div className="container-custom section-padding">
        <div className="max-w-4xl">
          <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Professional Gutter Cleaning in Golborne</h2>
